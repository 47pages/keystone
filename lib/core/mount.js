...
function mount(mountPath, parentApp, events) {
	...
	// Serve private static files (must come *AFTER* the route inclusion above for proper security middleware support)
	app.use('/private', express.static(this.get('root_dirname') + '/private'));
